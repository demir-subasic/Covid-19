...
const countries = [
  ...
  { code: "BL", searchName: "St-Barthelemy", label: "Saint Barthelemy", phone: "590" },
  { code: "BM", searchName: "Bermuda", label: "Bermuda", phone: "1-441" },
  { code: "BN", searchName: "Brunei", label: "Brunei", phone: "673" },
  { code: "BO", searchName: "Bolivia", label: "Bolivia", phone: "591" },
  {
    code: "BQ",
    searchName: "Bonaire-Sint-Eustatius-and-Saba",
  ...
  { code: "CD", searchName: "Congo-Democratic-Republic", label: "Congo (DRC)", phone: "243" },
  { code: "CF", searchName: "Central-African-Republic", label: "Central African Republic", phone: "236" },
  { code: "CG", searchName: "Congo", label: "Congo (Republic)", phone: "242" },
  {
    code: "CH",
  ...
  { code: "CI", searchName: "Cote-d'Ivoire", label: "Côte d'Ivoire", phone: "225" },
  ...
  { code: "CV", searchName: "Cape-Verde", label: "Cape Verde", phone: "238" },
  {
    code: "CW",
    searchName: "Curacao",
    label: "Curaçao",
  ...
  { code: "CZ", searchName: "Czech-Republic", label: "Czech Republic", phone: "420" },
  { code: "DE", searchName: "Germany", label: "Germany", phone: "49" },
  ...
  { code: "FK", searchName: "Falkland-Islands", label: "Falkland Islands", phone: "500" },
  { code: "FM", searchName: "Micronesia", label: "Micronesia", phone: "691" },
  {
    code: "FO",
  ...
  { code: "FR", searchName: "France", label: "France", phone: "33" },
  ...
  { code: "GF", searchName: "French-Guiana", label: "French Guiana", phone: "594" },
  { code: "GG", searchName: "Guernsey", label: "Guernsey", phone: "44" },
  ...
  { code: "GQ", searchName: "Equatorial-Guinea", label: "Equatorial Guinea", phone: "240" },
  ...
  { code: "GW", searchName: "Guinea-Bissau", label: "Guinea-Bissau", phone: "245" },
  ...
  { code: "KN", searchName: "Saint-Kitts-and-Nevis", label: "Saint Kitts and Nevis", phone: "1-869" },
  { code: "KP", searchName: "North-Korea", label: "North Korea", phone: "850" },
  { code: "KR", searchName: "South-Korea", label: "South Korea", phone: "82" },
  { code: "KW", searchName: "Kuwait", label: "Kuwait", phone: "965" },
  { code: "KY", searchName: "Cayman-Islands", label: "Cayman Islands", phone: "1-345" },
  { code: "KZ", searchName: "Kazakhstan", label: "Kazakhstan", phone: "7" },
  { code: "LA", searchName: "Laos", label: "Laos", phone: "856" },
  { code: "LB", searchName: "Lebanon", label: "Lebanon", phone: "961" },
  { code: "LC", searchName: "Saint-Lucia", label: "Saint Lucia", phone: "1-758" },
  { code: "LI", searchName: "Liechtenstein", label: "Liechtenstein", phone: "423" },
  ...
  { code: "MD", searchName: "Moldova", label: "Moldova", phone: "373" },
  { code: "ME", searchName: "Montenegro", label: "Montenegro", phone: "382" },
  { code: "MF", searchName: "St-Martin", label: "Saint Martin", phone: "590" },
  { code: "MG", searchName: "Madagascar", label: "Madagascar", phone: "261" },
  { code: "MH", searchName: "Marshall-Islands", label: "Marshall Islands", phone: "692" },
  { code: "MK", searchName: "North-Macedonia", label: "North Macedonia", phone: "389" },
  ...
  { code: "MP", searchName: "Northern-Mariana-Islands", label: "Northern Mariana Islands", phone: "1-670" },
  ...
  { code: "NC", searchName: "New-Caledonia", label: "New Caledonia", phone: "687" },
  { code: "NE", searchName: "Niger", label: "Niger", phone: "227" },
  { code: "NF", searchName: "Norfolk-Island", label: "Norfolk Island", phone: "672" },
  ...
  { code: "PF", searchName: "French-Polynesia", label: "French Polynesia", phone: "689" },
  { code: "PG", searchName: "Papua-New-Guinea", label: "Papua New Guinea", phone: "675" },
  ...
  { code: "PM", searchName: "Saint-Pierre-and-Miquelon", label: "Saint Pierre and Miquelon", phone: "508" },
  { code: "PN", searchName: "Pitcairn", label: "Pitcairn", phone: "870" },
  { code: "PR", searchName: "Puerto-Rico", label: "Puerto Rico", phone: "1-787,1-939" },
  { code: "PS", searchName: "Palestinian-Territory", label: "Palestinian Territory", phone: "970" },
  ...
  { code: "RE", searchName: "Reunion", label: "Réunion", phone: "262" },
  { code: "RO", searchName: "Romania", label: "Romania", phone: "40" },
  { code: "RS", searchName: "Serbia", label: "Serbia", phone: "381" },
  { code: "RU", searchName: "Russia", label: "Russia", phone: "7" },
  { code: "RW", searchName: "Rwanda", label: "Rwanda", phone: "250" },
  { code: "SA", searchName: "Saudi-Arabia", label: "Saudi Arabia", phone: "966" },
  { code: "SB", searchName: "Solomon-Islands", label: "Solomon Islands", phone: "677" },
  ...
  { code: "SH", searchName: "Saint-Helena", label: "Saint Helena", phone: "290" },
  { code: "SI", searchName: "Slovenia", label: "Slovenia", phone: "386" },
  { code: "SJ", searchName: "Svalbard-and-Jan-Mayen", label: "Svalbard and Jan Mayen", phone: "47" },
  { code: "SK", searchName: "Slovakia", label: "Slovakia", phone: "421" },
  { code: "SL", searchName: "Sierra-Leone", label: "Sierra Leone", phone: "232" },
  { code: "SM", searchName: "San-Marino", label: "San Marino", phone: "378" },
  { code: "SN", searchName: "Senegal", label: "Senegal", phone: "221" },
  ...
  { code: "ST", searchName: "Sao-Tome-and-Principe", label: "Sao Tome and Principe", phone: "239" },
  { code: "SV", searchName: "El-Salvador", label: "El Salvador", phone: "503" },
  { code: "SX", searchName: "Sint-Maarten", label: "Sint Maarten", phone: "1-721" },
  { code: "SY", searchName: "Syria", label: "Syria", phone: "963" },
  { code: "SZ", searchName: "Eswatini", label: "Eswatini", phone: "268" },
  { code: "TC", searchName: "Turks-and-Caicos-Islands", label: "Turks and Caicos Islands", phone: "1-649" },
  { code: "TD", searchName: "Chad", label: "Chad", phone: "235" },
  { code: "TF", searchName: "French-Southern-Territories", label: "French Southern Territories", phone: "262" },
  ...
  { code: "TK", searchName: "Tokelau", label: "Tokelau", phone: "690" },
  { code: "TL", searchName: "Timor-Leste", label: "Timor-Leste", phone: "670" },
  { code: "TM", searchName: "Turkmenistan", label: "Turkmenistan", phone: "993" },
  ...
  { code: "TT", searchName: "Trinidad-and-Tobago", label: "Trinidad and Tobago", phone: "1-868" },
  { code: "TV", searchName: "Tuvalu", label: "Tuvalu", phone: "688" },
  { code: "TW", searchName: "Taiwan", label: "Taiwan", phone: "886" },
  { code: "TZ", searchName: "Tanzania", label: "Tanzania", phone: "255" },
  { code: "UA", searchName: "Ukraine", label: "Ukraine", phone: "380" },
  { code: "UG", searchName: "Uganda", label: "Uganda", phone: "256" },
  { code: "US", searchName: "USA", label: "United States", phone: "1" },
  { code: "UY", searchName: "Uruguay", label: "Uruguay", phone: "598" },
  { code: "UZ", searchName: "Uzbekistan", label: "Uzbekistan", phone: "998" },
  { code: "VA", searchName: "Vatican-City", label: "Vatican City", phone: "39" },
  { code: "VC", searchName: "Saint-Vincent-and-the-Grenadines", label: "Saint Vincent and the Grenadines", phone: "1-784" },
  { code: "VE", searchName: "Venezuela", label: "Venezuela", phone: "58" },
  { code: "VG", searchName: "British-Virgin-Islands", label: "British Virgin Islands", phone: "1-284" },
  { code: "VI", searchName: "US-Virgin-Islands", label: "U.S. Virgin Islands", phone: "1-340" },
  { code: "VN", searchName: "Vietnam", label: "Vietnam", phone: "84" },
  { code: "VU", searchName: "Vanuatu", label: "Vanuatu", phone: "678" },
  { code: "WF", searchName: "Wallis-and-Futuna", label: "Wallis and Futuna", phone: "681" },
  ...
  { code: "ZA", searchName: "South-Africa", label: "South Africa", phone: "27" },
